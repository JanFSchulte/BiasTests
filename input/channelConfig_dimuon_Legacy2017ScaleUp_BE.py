...
def provideUncertainties(mass):
	...
	result["bkgParams"] = {"bkg_a":0.00514034793324724334, "bkg_b":0.00716699437487695098, "bkg_c":0.02125506687601379577, "bkg_d":0.00000000000000000000, "bkg_e":0.00209387826834573493, "bkg_b2":0.02256178712858768545, "bkg_c2":0.33506158930680013386, "bkg_d2":0.41091992883305550333, "bkg_thr":0.00822881935437757769}
...
def provideCorrelations():
	...
	#result['bkgUncert'] = 'dimuon_Legacy2017ScaleUp_BE' 
	#result['res'] = 'dimuon' 
	#result['bkgParams'] = 'dimuon_Legacy2017ScaleUp_BE' 
	result['sigEff'] = 'dimuon' 
	result['massScale'] = 'dimuon' 
	result['bkgUncert'] = 'dimuon_Legacy2017ScaleUp_BE' 
	result['res'] = 'dimuon_Legacy2017ScaleUp_BE' 
...
def loadBackgroundShape(ws,useShapeUncert=False):
	...
	bkg_a = RooRealVar('bkg_a_dimuon_Legacy2017ScaleUp_BE','bkg_a_dimuon_Legacy2017ScaleUp_BE',5.797887658)
	bkg_b = RooRealVar('bkg_b_dimuon_Legacy2017ScaleUp_BE','bkg_b_dimuon_Legacy2017ScaleUp_BE',-0.003610594617)
	bkg_c = RooRealVar('bkg_c_dimuon_Legacy2017ScaleUp_BE','bkg_c_dimuon_Legacy2017ScaleUp_BE',1.700547828e-06)
	bkg_d = RooRealVar('bkg_d_dimuon_Legacy2017ScaleUp_BE','bkg_d_dimuon_Legacy2017ScaleUp_BE',0.0)
	bkg_e = RooRealVar('bkg_e_dimuon_Legacy2017ScaleUp_BE','bkg_e_dimuon_Legacy2017ScaleUp_BE',-2.085741359)

	bkg_b2 = RooRealVar('bkg_b2_dimuon_Legacy2017ScaleUp_BE','bkg_b2_dimuon_Legacy2017ScaleUp_BE',-0.001593103406)
	bkg_c2 = RooRealVar('bkg_c2_dimuon_Legacy2017ScaleUp_BE','bkg_c2_dimuon_Legacy2017ScaleUp_BE',2.492418619e-08)
	bkg_d2 = RooRealVar('bkg_d2_dimuon_Legacy2017ScaleUp_BE','bkg_d2_dimuon_Legacy2017ScaleUp_BE',-3.304615108e-12)
	bkg_thr = RooRealVar('bkg_thr_dimuon_Legacy2017ScaleUp_BE','bkg_thr_dimuon_Legacy2017ScaleUp_BE',847.5604991)
	...
	bkg_syst_a = RooRealVar('bkg_syst_a_dimuon_Legacy2017ScaleUp_BE','bkg_syst_a_dimuon_Legacy2017ScaleUp_BE',1.0)
	bkg_syst_b = RooRealVar('bkg_syst_b_dimuon_Legacy2017ScaleUp_BE','bkg_syst_b_dimuon_Legacy2017ScaleUp_BE',0.0)
	...
	if useShapeUncert:
		...
		for uncert in bkgParamsUncert:
			addBkgUncertPrior(ws,uncert,"dimuon_Legacy2017ScaleUp_BE",bkgParamsUncert[uncert] )
		ws.factory("ZPrimeMuonBkgPdf4::bkgpdf_dimuon_Legacy2017ScaleUp_BE(mass_dimuon_Legacy2017ScaleUp_BE, bkg_a_dimuon_Legacy2017ScaleUp_BE_forUse, bkg_b_dimuon_Legacy2017ScaleUp_BE_forUse, bkg_c_dimuon_Legacy2017ScaleUp_BE_forUse,bkg_d_dimuon_Legacy2017ScaleUp_BE_forUse,bkg_e_dimuon_Legacy2017ScaleUp_BE_forUse, bkg_b2_dimuon_Legacy2017ScaleUp_BE_forUse, bkg_c2_dimuon_Legacy2017ScaleUp_BE_forUse,bkg_d2_dimuon_Legacy2017ScaleUp_BE_forUse,bkg_thr_dimuon_Legacy2017ScaleUp_BE_forUse,bkg_syst_a_dimuon_Legacy2017ScaleUp_BE,bkg_syst_b_dimuon_Legacy2017ScaleUp_BE)")
		ws.factory("ZPrimeMuonBkgPdf4::bkgpdf_fullRange(massFullRange, bkg_a_dimuon_Legacy2017ScaleUp_BE_forUse, bkg_b_dimuon_Legacy2017ScaleUp_BE_forUse, bkg_c_dimuon_Legacy2017ScaleUp_BE_forUse,bkg_d_dimuon_Legacy2017ScaleUp_BE_forUse,bkg_e_dimuon_Legacy2017ScaleUp_BE_forUse, bkg_b2_dimuon_Legacy2017ScaleUp_BE_forUse, bkg_c2_dimuon_Legacy2017ScaleUp_BE_forUse,bkg_d2_dimuon_Legacy2017ScaleUp_BE_forUse,bkg_thr_dimuon_Legacy2017ScaleUp_BE_forUse,bkg_syst_a_dimuon_Legacy2017ScaleUp_BE,bkg_syst_b_dimuon_Legacy2017ScaleUp_BE)")
	else:
		ws.factory("ZPrimeMuonBkgPdf4::bkgpdf_dimuon_Legacy2017ScaleUp_BE(mass_dimuon_Legacy2017ScaleUp_BE, bkg_a_dimuon_Legacy2017ScaleUp_BE, bkg_b_dimuon_Legacy2017ScaleUp_BE, bkg_c_dimuon_Legacy2017ScaleUp_BE,bkg_d_dimuon_Legacy2017ScaleUp_BE,bkg_e_dimuon_Legacy2017ScaleUp_BE, bkg_b2_dimuon_Legacy2017ScaleUp_BE, bkg_c2_dimuon_Legacy2017ScaleUp_BE,bkg_d2_dimuon_Legacy2017ScaleUp_BE,bkg_thr_dimuon_Legacy2017ScaleUp_BE,bkg_syst_a_dimuon_Legacy2017ScaleUp_BE,bkg_syst_b_dimuon_Legacy2017ScaleUp_BE)")
		ws.factory("ZPrimeMuonBkgPdf4::bkgpdf_fullRange(massFullRange, bkg_a_dimuon_Legacy2017ScaleUp_BE, bkg_b_dimuon_Legacy2017ScaleUp_BE, bkg_c_dimuon_Legacy2017ScaleUp_BE,bkg_d_dimuon_Legacy2017ScaleUp_BE,bkg_e_dimuon_Legacy2017ScaleUp_BE, bkg_b2_dimuon_Legacy2017ScaleUp_BE, bkg_c2_dimuon_Legacy2017ScaleUp_BE,bkg_d2_dimuon_Legacy2017ScaleUp_BE,bkg_thr_dimuon_Legacy2017ScaleUp_BE,bkg_syst_a_dimuon_Legacy2017ScaleUp_BE,bkg_syst_b_dimuon_Legacy2017ScaleUp_BE)")
	return ws
