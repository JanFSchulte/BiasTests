...
def provideUncertainties(mass):
	...
	result["bkgParams"] = {"bkg_a":0.00461757442681677132, "bkg_b":0.00692762454757793640, "bkg_c":0.02655690041330530798, "bkg_d":0.00000000000000000000, "bkg_e":0.00205424377278767790, "bkg_b2":0.01751615797953253589, "bkg_c2":0.20511269636761975121, "bkg_d2":0.46706001769637223164, "bkg_thr":0.00872452341325517799}
...
def provideCorrelations():
	...
	#result['bkgUncert'] = 'dimuon_Legacy2018MuonID_BE' 
	#result['res'] = 'dimuon' 
	#result['bkgParams'] = 'dimuon_Legacy2018MuonID_BE' 
	result['sigEff'] = 'dimuon' 
	result['massScale'] = 'dimuon' 
	result['bkgUncert'] = 'dimuon_Legacy2018MuonID_BE' 
	result['res'] = 'dimuon_BE' 
	result['reco'] = 'dimuon_Legacy2018MuonID_BE' 
	result['bkgParams'] = 'dimuon_Legacy2018MuonID_BE' 
...
def loadBackgroundShape(ws,useShapeUncert=False):
	...
	bkg_a = RooRealVar('bkg_a_dimuon_Legacy2018MuonID_BE','bkg_a_dimuon_Legacy2018MuonID_BE',5.918909361)
	bkg_b = RooRealVar('bkg_b_dimuon_Legacy2018MuonID_BE','bkg_b_dimuon_Legacy2018MuonID_BE',-0.00440644679)
	bkg_c = RooRealVar('bkg_c_dimuon_Legacy2018MuonID_BE','bkg_c_dimuon_Legacy2018MuonID_BE',2.153530034e-06)
	bkg_d = RooRealVar('bkg_d_dimuon_Legacy2018MuonID_BE','bkg_d_dimuon_Legacy2018MuonID_BE',0.0)
	bkg_e = RooRealVar('bkg_e_dimuon_Legacy2018MuonID_BE','bkg_e_dimuon_Legacy2018MuonID_BE',-1.987886009)

	bkg_b2 = RooRealVar('bkg_b2_dimuon_Legacy2018MuonID_BE','bkg_b2_dimuon_Legacy2018MuonID_BE',-0.001661457885)
	bkg_c2 = RooRealVar('bkg_c2_dimuon_Legacy2018MuonID_BE','bkg_c2_dimuon_Legacy2018MuonID_BE',3.604676784e-08)
	bkg_d2 = RooRealVar('bkg_d2_dimuon_Legacy2018MuonID_BE','bkg_d2_dimuon_Legacy2018MuonID_BE',-2.476023856e-12)
	bkg_thr = RooRealVar('bkg_thr_dimuon_Legacy2018MuonID_BE','bkg_thr_dimuon_Legacy2018MuonID_BE',649.491469)
	...
	bkg_syst_a = RooRealVar('bkg_syst_a_dimuon_Legacy2018MuonID_BE','bkg_syst_a_dimuon_Legacy2018MuonID_BE',1.0)
	bkg_syst_b = RooRealVar('bkg_syst_b_dimuon_Legacy2018MuonID_BE','bkg_syst_b_dimuon_Legacy2018MuonID_BE',0.0)
	...
	if useShapeUncert:
		...
		for uncert in bkgParamsUncert:
			addBkgUncertPrior(ws,uncert,"dimuon_Legacy2018MuonID_BE",bkgParamsUncert[uncert] )
		ws.factory("ZPrimeMuonBkgPdf4::bkgpdf_dimuon_Legacy2018MuonID_BE(mass_dimuon_Legacy2018MuonID_BE, bkg_a_dimuon_Legacy2018MuonID_BE_forUse, bkg_b_dimuon_Legacy2018MuonID_BE_forUse, bkg_c_dimuon_Legacy2018MuonID_BE_forUse,bkg_d_dimuon_Legacy2018MuonID_BE_forUse,bkg_e_dimuon_Legacy2018MuonID_BE_forUse, bkg_b2_dimuon_Legacy2018MuonID_BE_forUse, bkg_c2_dimuon_Legacy2018MuonID_BE_forUse,bkg_d2_dimuon_Legacy2018MuonID_BE_forUse,bkg_thr_dimuon_Legacy2018MuonID_BE_forUse,bkg_syst_a_dimuon_Legacy2018MuonID_BE,bkg_syst_b_dimuon_Legacy2018MuonID_BE)")
		ws.factory("ZPrimeMuonBkgPdf4::bkgpdf_fullRange(massFullRange, bkg_a_dimuon_Legacy2018MuonID_BE_forUse, bkg_b_dimuon_Legacy2018MuonID_BE_forUse, bkg_c_dimuon_Legacy2018MuonID_BE_forUse,bkg_d_dimuon_Legacy2018MuonID_BE_forUse,bkg_e_dimuon_Legacy2018MuonID_BE_forUse, bkg_b2_dimuon_Legacy2018MuonID_BE_forUse, bkg_c2_dimuon_Legacy2018MuonID_BE_forUse,bkg_d2_dimuon_Legacy2018MuonID_BE_forUse,bkg_thr_dimuon_Legacy2018MuonID_BE_forUse,bkg_syst_a_dimuon_Legacy2018MuonID_BE,bkg_syst_b_dimuon_Legacy2018MuonID_BE)")
	else:
		ws.factory("ZPrimeMuonBkgPdf4::bkgpdf_dimuon_Legacy2018MuonID_BE(mass_dimuon_Legacy2018MuonID_BE, bkg_a_dimuon_Legacy2018MuonID_BE, bkg_b_dimuon_Legacy2018MuonID_BE, bkg_c_dimuon_Legacy2018MuonID_BE,bkg_d_dimuon_Legacy2018MuonID_BE,bkg_e_dimuon_Legacy2018MuonID_BE, bkg_b2_dimuon_Legacy2018MuonID_BE, bkg_c2_dimuon_Legacy2018MuonID_BE,bkg_d2_dimuon_Legacy2018MuonID_BE,bkg_thr_dimuon_Legacy2018MuonID_BE,bkg_syst_a_dimuon_Legacy2018MuonID_BE,bkg_syst_b_dimuon_Legacy2018MuonID_BE)")
		ws.factory("ZPrimeMuonBkgPdf4::bkgpdf_fullRange(massFullRange, bkg_a_dimuon_Legacy2018MuonID_BE, bkg_b_dimuon_Legacy2018MuonID_BE, bkg_c_dimuon_Legacy2018MuonID_BE,bkg_d_dimuon_Legacy2018MuonID_BE,bkg_e_dimuon_Legacy2018MuonID_BE, bkg_b2_dimuon_Legacy2018MuonID_BE, bkg_c2_dimuon_Legacy2018MuonID_BE,bkg_d2_dimuon_Legacy2018MuonID_BE,bkg_thr_dimuon_Legacy2018MuonID_BE,bkg_syst_a_dimuon_Legacy2018MuonID_BE,bkg_syst_b_dimuon_Legacy2018MuonID_BE)")
	return ws
